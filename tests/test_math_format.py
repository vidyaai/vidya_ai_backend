...
messages = [
    {
        "role": "system",
        "content": "Use LaTeX ONLY: \\( \\) for inline math, \\[ \\] for display math. NEVER use HTML, MathML tags, or any markup other than LaTeX. NEVER reference 'MathML' or include HTML attributes like display='block'.",
    },
    {
        "role": "user",
        "content": "Write Newton's second law F = ma with proper math formatting",
    },
]
